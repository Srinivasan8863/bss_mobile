    ...
    <a class="list-group-item list-group-item-action" style="padding:5px;margin:5px;" aria-current="true">
        <div class="row">
            ...
            <div class="col-xs-7 col-sm-7 col-md-7">
                ...
                value="<?php echo $options[0]->option_id;?>" >
                <?php
                }
                else
                {
               ...
               if($incart>0)
               {
                ...
                <div id="spanqty<?php echo $products[$i]->products_id; ?>" <?php if($incart==0){ ?> style="display:none;" <?php } ?>>
                    <div class="input-group">
                        ...
                        <input type="text" readonly class="form-control" maxlength="4" size="4" name="qty<?php echo $products[$i]->products_id; ?>" id="qty<?php echo $products[$i]->products_id; ?>"
                        value="<?php echo $cartquantity; ?>" style="margin-top: -20px;">&nbsp;
                        <div class="input-group-btn">
