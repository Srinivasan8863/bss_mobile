            ...
            <a class="list-group-item list-group-item-action" style="padding:5px;margin:5px;" aria-current="true">
                <div class="row">
                    ...
                    <div class="col-xs-7 col-sm-7 col-md-7">
                        ...
                        if (count($options) == 1) {
                        ?>
                            <input type="hidden" name="option_id<?php echo $options[0]->option_id; ?>" id="option_id<?php echo $products[$i]->products_id; ?>" class="optionid" value="<?php echo $options[0]->option_id; ?>--<?php echo $options[0]->weight; ?>--<?php echo $options[0]->unit; ?>--<?php echo $options[0]->price; ?>--<?php echo $options[0]->discount_price; ?>--<?php echo $options[0]->stock; ?>">
                            <?php
                        } else {
                            if (count($options) > 0) {
                            ?>
                                <br>
                                <select name="option_id<?php echo $options[0]->option_id; ?>" id="option_id<?php echo $products[$i]->products_id; ?>" class="optionid" onchange="showAddButton(<?php echo $products[$i]->products_id; ?>,this.value);">
                                    <?php
